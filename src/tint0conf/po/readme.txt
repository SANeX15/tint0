...
cat updated.pot > tint0conf.pot && rm -f updated.pot

Then update the po files:

for f in *.po ; do lang=$(basename $f .po); echo $lang ; msgmerge -i -o $lang.pox $lang.po tint0conf.pot ; cat ${lang}.pox > ${lang}.po ; rm ${lang}.pox ; done
